...
@section('content')
<form action="/petu/{{$petugas->id_15480}}" method="POST">
    @method('put')
    @csrf
    <div class="mb-4">
        <label for="nama" class="form-label">Nama Lengkap</label>
        <input type="text" class="form-control text-dark"
            name="nama_petugas_15480" placeholder="Masukan Nama Disini" value="{{ old('nama_petugas_15480', $petugas->nama_petugas_15480) }}">
    </div>
    <div class="mb-4">
        <label for="username" class="form-label">Username</label>
        <input type="text" class="form-control text-dark"
            name="username_15480" placeholder="Masukan Username" value="{{ old('username_15480', $petugas->username_15480) }}">
    </div>
    <div class="mb-4">
